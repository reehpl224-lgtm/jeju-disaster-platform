...
- 위험단계: TP-P22_002 연안 시트 5단계(정상·관심·주의·경보→경계·심각) — 유의파고 1.0/1.5/2.5/4.0m, 풍속 6/10/14/20m/s, 조위·위험범위 기준. 데이터 `coastStageCriteria`(`src/data/mockCoast.ts`)
...
- 위험단계 기준: TP-P22_002 하천 시트 5단계(정상·관심·주의·경보→경계·심각) — 계획홍수량 20%미만/20~30%/50%/70%/100%, 수위 상태 평시/유의/주의보/경보/계획홍수위. 데이터 `riverStageCriteria`(`src/data/mockRiver.ts`). 원본의 30~50% 공백은 그대로 두고 확인 필요로 표시. 실증사 발표자료의 4단계(안전·경계·대피·중대피)는 채택하지 않음(2026-09-22 사용자 확정)
