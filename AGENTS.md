...
- **위험등급 임계값** (`src/data/marineAlertThresholds.ts`에 로직으로 구현되어 있음, 출처:
  ...
  - 5단계: 정상/관심/주의/경보(→앱 라벨 '경계')/심각(→앱 라벨 '위험')
  - 염분: 정상 ≥31.0psu · 관심 28.0~31.0 · 주의 26.0~28.0 · 경계 24.0~26.0 · **위험 <24.0psu**
  - 수온: 정상 <25.0℃ · 관심 25.0~28.0℃ · 주의(28.0℃ 도달) · 경계(28.0℃↑ 1~2일 지속) ·
    **위험(28.0℃↑ 3일 이상 지속)**
  - 복합 규칙: 수온≥28.0℃ AND 염분≤26.0psu → 무조건 위험(심각) / 수온≥28.0℃ AND 염분≤28.0psu →
