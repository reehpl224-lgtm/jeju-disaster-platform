...
export const incidentRecords: IncidentRecord[] = [
  {
    ...
    title: "한천 범람 대응 — 경계 3단계 발령 및 주민 대피 안내",
    grade: "심각 (Lv.4)",
    duration: "4시간 38분",
    area: "한천 중·하류 1.2km",
    approver: "홍길동 팀장",
  ...
  },
  {
    ...
    title: "이호테우 해수욕장 익수 위험 — 해경 출동 및 현장 통제",
    grade: "경계 (Lv.3)",
    duration: "1시간 12분",
    area: "이호테우 1구역",
    approver: "김제주 담당",
  ...
  },
  {
    ...
    title: "추자도 주변 고수온 주의 — e-SOP 주의 단계 승인 및 어가 안내",
    grade: "주의 (Lv.2)",
    duration: "6시간 00분",
    area: "추자도 연안 양식장 8개소",
    approver: "이한라 담당",
  ...
  },
  {
    ...
    title: "산지천 수위 급상승 — 경계 2단계 차단기 작동 및 현장 출동",
    grade: "경계 (Lv.3)",
    duration: "2시간 51분",
    area: "산지천 하류 0.8km",
    approver: "홍길동 팀장",
  ...
  },
  {
    ...
    title: "성산포 방파제 무단진입 — 현장 경보 및 해경 공조 출동",
    grade: "심각 (Lv.4)",
    duration: "0시간 47분",
    area: "성산포 방파제 전구간",
    approver: "김제주 담당",
  ...
  },
  {
    ...
    title: "한림 연안 저염분수 주의 — 48시간 예측 기반 어가 맞춤 안내",
    grade: "주의 (Lv.2)",
    duration: "3시간 25분",
    area: "한림읍 연안 양식장 5개소",
    approver: "이한라 담당",
...
export const incidentImpact = {
  river: { label: "하천 범람", floodedSection: "한천 중류 320m 구간", radius: "약 1.2km", households: "약 340세대" },
...
export const incidentSopApprovals: IncidentSopApproval[] = [
  ...
  { stage: "3단계 · 심각", content: "주민 대피 안내 발송 승인", approver: "김민준 팀장", time: "13:05", note: "대상 340세대" },
...
export const incidentAgencyActions: IncidentAgencyAction[] = [
  { agency: "제주소방서", action: "현장 출동 및 주민 안내", dispatchedAt: "11:25", result: "완료", confirmedBy: "박현장 반장" },
  { agency: "제주경찰서", action: "도로 통제 및 대피 유도", dispatchedAt: "13:10", result: "완료", confirmedBy: "최통제 팀장" },
...
export const incidentAttachments: IncidentAttachment[] = [
  { id: "att1", name: "CCTV 탐지 마스킹 이미지 (한천_CAM02)", time: "2026-09-04 09:18" },
  { id: "att2", name: "수위 센서 시계열 데이터 (한천_S04)", time: "2026-09-04 09:22" },
