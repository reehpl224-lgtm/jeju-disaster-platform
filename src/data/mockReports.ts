...
export const incidentRecords: IncidentRecord[] = [
  {
    ...
    title: "효돈천(쇠소깍) 범람 대응 — 중대피 3단계 발령 및 주민 대피 안내",
    grade: "중대피 (3단계)",
    duration: "8시간 28분",
    ...
    timeline: [
      { time: "09:14", stage: "감지", content: "수위 센서 임계값 근접 감지", owner: "시스템 자동" },
      { time: "09:42", stage: "경계", content: "1단계 발령 승인", owner: "김민준 팀장" },
      { time: "11:20", stage: "대피", content: "2단계 상향 승인 · 차단기 작동", owner: "김민준 팀장" },
      { time: "13:05", stage: "중대피", content: "3단계 상향 승인 · 주민 대피 안내 발송", owner: "김민준 팀장" },
      { time: "16:10", stage: "회복", content: "수위 하강 확인 · 단계 하향 검토", owner: "박현장 반장" },
      { time: "17:42", stage: "종료", content: "상황 종료 승인", owner: "김민준 팀장" },
    ],
    sopApprovals: [
      { stage: "1단계 · 경계", content: "안전 → 경계 상향 승인", approver: "김민준 팀장", time: "09:42", note: "자동 감지 기반" },
      { stage: "2단계 · 대피", content: "차단기 작동 · 현장 통제 승인", approver: "김민준 팀장", time: "11:20", note: "센서 교차검증 완료" },
      { stage: "3단계 · 중대피", content: "주민 대피 안내 발송 승인", approver: "김민준 팀장", time: "13:05", note: "대상 80세대" },
  ...
  },
  {
    ...
    timeline: [
      { time: "05:40", stage: "감지", content: "수온 28℃ 도달 감지", owner: "시스템 자동" },
      { time: "06:15", stage: "주의", content: "1단계(주의) 발령 승인", owner: "이한라 담당" },
    ...
    sopApprovals: [
      { stage: "자동 감지", content: "임계값 근접 감지 — 담당자 확인 요청", approver: "시스템 자동", time: "05:40", note: "자동 감지 기반" },
      { stage: "1단계 · 주의", content: "어가 맞춤 SOP 안내 발송 승인", approver: "이한라 담당", time: "06:15", note: "대상 8개소" },
  ...
  },
  {
    ...
    title: "효돈천(돈내코) 수위 급상승 — 대피 2단계 차단기 작동 및 현장 출동",
    grade: "대피 (2단계)",
    duration: "2시간 51분",
    ...
    timeline: [
      { time: "19:26", stage: "경계", content: "1단계 발령 · 수위 상승 감지", owner: "시스템 자동" },
      { time: "20:10", stage: "대피", content: "2단계 상향 승인 · 차단기 작동", owner: "홍길동 팀장" },
      { time: "21:00", stage: "대피", content: "현장 출동 · 서귀포소방서 점검", owner: "홍길동 팀장" },
      { time: "22:17", stage: "종료", content: "수위 안정 확인 후 상황 종료 승인", owner: "홍길동 팀장" },
    ],
    sopApprovals: [
      { stage: "1단계 · 경계", content: "안전 → 경계 상향 승인", approver: "홍길동 팀장", time: "19:26", note: "자동 감지 기반" },
      { stage: "2단계 · 대피", content: "차단기 작동 승인", approver: "홍길동 팀장", time: "20:10", note: "센서 교차검증 완료" },
  ...
  },
  {
    ...
    timeline: [
      { time: "10:55", stage: "감지", content: "염분 하락 추세 감지", owner: "시스템 자동" },
      { time: "11:30", stage: "주의", content: "1단계(주의) 발령 승인", owner: "이한라 담당" },
    ...
    sopApprovals: [
      { stage: "자동 감지", content: "임계값 근접 감지 — 담당자 확인 요청", approver: "시스템 자동", time: "10:55", note: "자동 감지 기반" },
      { stage: "1단계 · 주의", content: "어가 맞춤 SOP 안내 발송 승인", approver: "이한라 담당", time: "11:30", note: "대상 5개소" },
