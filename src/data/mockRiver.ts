 ...
 * 담당자 몫(오경보 리스크). observedMm은 riverRiskBasis.rainfall.value(87.4mm)와 동일 수치.
 */
export const riverSuddenRainAlert = {
  forecastMm: 50,
  observedMm: 87.4,
  detectedAt: "14:18",
  trendNote: "최근 30분간 강우 강도 급증",
  aiNote:
    "기상청 예보를 크게 초과하는 돌발 강우 패턴을 실측 데이터로 감지했습니다. 목표는 사전 예측이 아니라 상황을 빠르게 캐치해 담당자에게 조기 전달하는 것입니다.",
