...
export const riverStatuses: RiverStatus[] = [
  { id: "sanji", name: "산지천", level: "danger", stage: "2단계 · 경계", eta: "약 38분 후 (14:22)", updatedAt: "14:08" },
  { id: "han", name: "한천", level: "warning", stage: "1단계 · 주의", eta: "약 1시간 22분 후 (15:06)", updatedAt: "14:07" },
  { id: "byeongmun", name: "병문천", level: "caution", stage: "0단계 · 관심", eta: "예측 범위 외", updatedAt: "14:05" },
]
...
export const riverCctv = [
  { id: "c1", label: "산지천 상류", time: "14:06:38", detected: "확인됨", quality: "양호" },
  { id: "c2", label: "산지천 중류", time: "14:07:12", detected: "확인됨", quality: "양호" },
]

export const riverSensorCheck = [
  { id: "s1", name: "수위 센서 #SJ-01", status: "정상" as const, value: "3.82 m", detail: "레이더 수위 비교 ±0.04 m" },
  { id: "s2", name: "수위 센서 #SJ-02", status: "이상" as const, value: "데이터 없음", detail: "최종 수신 13:51 (17분 경과)" },
]
...
export const riverControlRows: RiverControlRow[] = [
  { id: "r1", river: "한천", stage: "⚠ 경계 2단계", location: "북제주 한천교 인근", gate: "정상 작동", dispatch: "완료", ack: "확인" },
  { id: "r2", river: "산지천", stage: "⚠ 경계 1단계", location: "제주시 산지천 하류", gate: "오류 발생", dispatch: "대기 중", ack: "미확인" },
  { id: "r3", river: "천미천", stage: "주의 단계", location: "서귀포시 천미천 중류", gate: "정상 작동", dispatch: "완료", ack: "확인" },
  { id: "r4", river: "효돈천", stage: "관심 단계", location: "서귀포시 효돈천 상류", gate: "정상 작동", dispatch: "미배정", ack: "확인" },
]

export const riverControlFailures = [
  { id: "f1", title: "산지천 — 차단기 동작 실패", time: "14:22 확인", cause: "현장 단말 통신 두절 (LTE 음영 구역)", action: "권장 대체 조치: 수동 통제 인력 즉시 파견" },
  { id: "f2", title: "산지천 — 출동 미배정", time: "14:25 확인", cause: "가용 인력 부족 (도청 소방 2팀 현장 투입 중)", action: "출동 요청 필요" },
]
...
export const riverControlTimeline: TimelineEntry[] = [
  ...
  { id: "ct4", time: "14:12", title: "한천·천미천 차단기 작동 확인" },
  { id: "ct5", time: "14:22", title: "산지천 차단기 오류 감지" },
  { id: "ct6", time: "14:25", title: "산지천 출동 미배정 확인 — 현재 진행 중" },
]

export const riverJointAgencies = [
  { id: "j1", agency: "제주도청 재난안전과", status: "현장 투입 중" },
  { id: "j2", agency: "서귀포시 상황실", status: "공조 수신 완료" },
  { id: "j3", agency: "소방서 (북제주)", status: "출동 완료" },
  { id: "j4", agency: "경찰서 (제주시)", status: "대기 중" },
]

export const riverDispatchRequest = {
  target: "한천 3구간 / 연안 B-07",
  stage: "⚠ 경계 3단계",
  eta: "14:22 (약 18분 후)",
  impact: "주거 342세대 / 관광객 밀집",
  requestedAt: "14:04",
  requester: "김현우 (제주도 재난안전과)",
  analysis: [
    "수위 급상승: 현재 3.8m / 경보 기준 4.0m",
    "강우 강도: 42mm/h (최근 30분 평균)",
    "범람 확률: 87% (모델 앙상블)",
    "인접 범람 이력: 2022-08-15, 2019-10-01",
    "GIS 취약 구간: 한천 교량 하부 2개소",
  ],
  process: [
...
export const riverClosure = {
  ...
  report: {
    ...
    casualties: "없음",
    property: "없음 (추정)",
    lesson: "산지천 차단기 통신 두절 재발 방지 위해 LTE 음영구역 보강 필요",
  },
}
